<div class="contaner-fluid" style="margin-top: 60px;">
  <div class="col-md-6">
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo"><h4 class="panel-title"><span class="glyphicon glyphicon-film"></span>&nbsp;&nbsp;Videos</h4></div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo"><h4 class="panel-title"><span class="glyphicon glyphicon-list-alt">Announcement</h4></div>
                <div class="panel-body">
